...
class OrbitPlotter:
    ...
    def plot_orbit(self, 
        ...
        if solutions:
            ...
            plt.scatter(final_pos[0], final_pos[1], color='black', 
                       label="spacecraft", s=60, marker='s')
    ...
    def _plot_orbit_on_axis(self, ax, solutions, planet_coordinates):
        ...
        if solutions:
            final_pos = solutions[-1][-1, :2]
            ax.scatter(final_pos[0], final_pos[1], color='black', 
                      label="spacecraft", s=40, marker='s')
